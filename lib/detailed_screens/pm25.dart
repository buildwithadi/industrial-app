...
class PM25DetailScreen extends StatefulWidget {
  final String deviceId;
  final String sessionCookie;

  const PM25DetailScreen({
    super.key,
  ...
  @override
  State<PM25DetailScreen> createState() => _PM25DetailScreenState();
}

class _PM25DetailScreenState extends State<PM25DetailScreen> {
  // --- STATE ---
  ...
  String _getAIInsight() {
    ...
    if (avgVal > 150) {
      ...
      return "🟠 Moderate to Unhealthy. Sensitive groups should reduce prolonged outdoor exertion.";
    } else if (avgVal > 35) {
      return "🟡 Moderate Air Quality. Acceptable for most, but maybe concerning for very sensitive individuals.";
    } else {
      return "🟢 Good Air Quality. PM 2.5 levels are low. Ideal conditions for outdoor activities.";
    }
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text("PM 2.5 Levels"),
        elevation: 0,
